...
- [ ] **Coyote Time**: Jump a tiiny bit after walking off a ledge for better jump feeling
- [ ] **Input Buffering**: Press the jump button a bit before actually hitting the ground to immediatly jump
